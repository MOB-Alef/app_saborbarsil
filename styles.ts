...
export const splashStyles = StyleSheet.create({
 container: { flex: 1, backgroundColor: COLORS.branco, justifyContent: "center", alignItems: "center" },
 contentContainer: { alignItems: "center" },
 logo: { width: 150, height: 150, marginBottom: 20, borderRadius: 75 }, // arredondada
 text: { fontSize: 24, color: COLORS.preto, fontWeight: "bold" },
});
...
// Abas / Home / Categorias / Favoritos
...
export const categoryButtonStyles = StyleSheet.create({
 ...
 image: {
   width: 50,        // tamanho padronizado
   height: 50,       // tamanho padronizado
   marginRight: 12,
   borderRadius: 25, // completamente arredondada
 },
